...
export const metadata = {
  ...
  description: 'Comfortable single room with street view at Place Lund Hotel in Lund, Sweden. 140cm Hilding Anders bed, parquet flooring, breakfast and dinner included.',
}

export default function SingleRoomPage() {
  const { heroImage, galleryImages } = getRoomImages('rooms/single-street')

  return (
    <main className="min-h-screen">
      <BreadcrumbSchema items={[{ name: 'Hotel', href: '/hotel' }, { name: 'Single Room', href: '/hotel/single-room' }]} />
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Our single room with street view is located on the third floor, offering a comfortable and practical space for solo travelers and business guests. The room features a premium Hilding Anders 140cm bed, parquet flooring, and all essential amenities for a pleasant stay in Lund.
              </p>
              ...
              <div className="bg-[#f5f5f5] p-6 rounded-lg border-2 border-[#004225] mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700"><strong>Location:</strong> Third floor, street view</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
              ...
              <div className="bg-[#FFFAF2] p-6 rounded-lg border-2 border-[#42001D] mb-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• Solo business travelers</li>
                  <li>• University visitors</li>
                  <li>• Short to medium stays</li>
                  <li>• Budget-conscious travelers</li>
                  <li>• Professionals on assignment</li>
                </ul>
              </div>
            </div>
