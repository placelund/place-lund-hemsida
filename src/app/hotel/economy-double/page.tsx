  ...
  return (
    <main className="min-h-screen">
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center">
        ...
        <Image src={heroImage} alt="Economy double room at Place Lund Hotel" fill className="object-cover" priority />
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#004225] mb-4">Economy Double Room</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="relative h-[400px] overflow-hidden rounded-lg">
                <Image src={galleryImages[0] || heroImage} alt="Economy double room" fill loading="lazy" className="object-cover" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                {galleryImages.slice(1, 3).map((image, index) => (
                  <div key={index} className="relative h-64 overflow-hidden rounded-lg">
                    <Image src={image} alt={`Economy room view ${index + 2}`} fill loading="lazy" className="object-cover" />
                  </div>
                ))}
              </div>
            </div>
