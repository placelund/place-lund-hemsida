      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://online.bookvisit.com/accommodation?channelId=7f2bb109-b49b-49f0-8d2c-113614f7f872" target="_blank" rel="noopener noreferrer" className="bg-[#004225] text-[#E3DAC9] font-semibold py-3 px-8 rounded-md hover:bg-[#42001D] transition-colors">
              Book Now
            </Link>
            <Link href="/hotel" className="bg-transparent text-[#004225] border-2 border-[#004225] font-semibold py-3 px-8 rounded-md hover:bg-[#FFFAF2]/20 transition-colors">
              View All Rooms
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="relative h-[400px] overflow-hidden rounded-lg">
                <Image src={galleryImages[0] || heroImage} alt="Twin garden view room" fill loading="lazy" className="object-cover" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                {galleryImages.slice(1, 9).map((image, index) => (
                  <div key={index} className="relative h-64 overflow-hidden rounded-lg">
                    <Image src={image} alt={`Twin garden room ${index + 2}`} fill loading="lazy" className="object-cover" />
                  </div>
                ))}
              </div>
            </div>
