...
export const metadata = {
  ...
  description: 'Margareta conference room at Place Lund Hotel in Lund, Sweden. Large meeting space for 30-50 people with premium AV equipment and flexible setup options.',
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                The Margareta conference room is our premier meeting space, designed to accommodate large groups of 30-50 participants. This spacious room offers maximum flexibility for various event formats, from conferences and seminars to training programs and corporate events.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Equipped with state-of-the-art technology and featuring abundant natural light, Margareta provides an inspiring and professional environment for your most important business gatherings.
              </p>
              ...
              <div className="bg-[#f5f5f5] p-6 rounded-lg border-2 border-[#004225] mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700"><strong>Capacity:</strong> 30-50 people</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700"><strong>Size:</strong> 75 m²</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700"><strong>Layout:</strong> Theater, classroom, banquet, reception</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700"><strong>Natural Light:</strong> Abundant, with blackout options</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700"><strong>Location:</strong> Main floor with separate entrance</span>
                  </li>
                </ul>
              </div>

              <div className="bg-[#f5f5f5] p-6 rounded-lg border-2 border-[#004225] mb-6">
                <h3 className="text-xl font-bold text-[#004225] mb-4">Premium Equipment & Amenities</h3>
                <ul className="grid grid-cols-2 gap-3">
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700">HD Projector & Screen</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700">Multiple Whiteboards</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700">Flipcharts</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700">Full Catering Service</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700">Stage/Platform</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
                    <span className="text-gray-700">Breakout Area</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#004225] font-bold text-xl">•</span>
              ...
              <div className="bg-[#FFFAF2] p-6 rounded-lg border-2 border-[#42001D] mb-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• Large conferences & seminars</li>
              ...
              <a
                href="/flyers/margareta-conference-flyer.pdf"
                download
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Margareta conference room offers premium pricing for our largest space. All packages include state-of-the-art AV equipment, WiFi, and full technical support.
            </p>
          </div>
            ...
            <div className="bg-[#FFFAF2] p-8 rounded-lg border-2 border-[#004225]">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-6 bg-[#f5f5f5] rounded-lg">
                  <div>
                    <p className="font-bold text-[#004225] text-lg">Maximum 90 people</p>
                    <p className="text-sm text-gray-600">Full room capacity</p>
                  </div>
                  <p className="text-3xl font-bold text-[#004225]">14,400 kr</p>
                </div>
              </div>
              <p className="text-center text-gray-600 text-sm mt-4">
                Ideal for conferences, seminars, and large gatherings
              </p>
            </div>
            ...
            <div className="bg-[#FFFAF2] p-8 rounded-lg border-2 border-[#004225]">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-6 bg-[#f5f5f5] rounded-lg">
                  ...
                  <p className="text-3xl font-bold text-[#004225]">21,600 kr</p>
                </div>
              </div>
              <p className="text-center text-gray-600 text-sm mt-4">
                Perfect for full-day events and training programs
              </p>
            </div>
          </div>
